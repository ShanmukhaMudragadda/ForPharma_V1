 ...
 */
export async function onboardNewOrganization(organizationData) {
    try {
        ...
        const schemaName = await schemaService.createOrganizationSchema(org.id, organizationData.name);
