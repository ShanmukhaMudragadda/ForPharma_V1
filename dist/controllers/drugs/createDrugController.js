export const createDrug = async (req, res) => {
    try {
        ...
        const { name, composition, manufacturer, indications, sideEffects, safetyAdvice, dosageForms, price, schedule, regulatoryApprovals, category, isAvailable = true, images, marketingMaterials } = req.body;
