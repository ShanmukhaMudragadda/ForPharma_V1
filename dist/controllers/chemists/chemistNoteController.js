...
export const createChemistNote = async (req, res) => {
    try {
...
export const getNotesForChemist = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
...
export const getChemistNotesByEmployee = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        ...
        // Build where clause
        const where = { createdById: employeeId };
        if (chemistId)
...
export const updateChemistNote = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
...
export const deleteChemistNote = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const noteId = req.params.noteId;
