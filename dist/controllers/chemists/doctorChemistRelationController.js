...
export const createDoctorChemistRelation = async (req, res) => {
    try {
...
export const getChemistsForDoctor = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
...
export const getDoctorsForChemist = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
...
export const deleteDoctorChemistRelation = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
