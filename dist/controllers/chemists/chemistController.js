...
export const createChemistController = async (req, res) => {
    try {
        const { name, type, chemistChainId, territoryId, email, phone, address, city, state, pincode, latitude, longitude, description, profilePictureUrl, visitingHours } = req.body;
...
export const updateChemist = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const chemistId = req.params.chemistId;
        const { name, type, chemistChainId, email, phone, address, city, state, pincode, latitude, longitude, description, profilePictureUrl, visitingHours } = req.body;
        // Validation
        if (!tenantDb) {
            return res.status(500).json({
                success: false,
...
export const deleteChemist = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const chemistId = req.params.chemistId;
        // Validation
...
export const getChemistListController = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
...
export const getChemistDetails = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const chemistId = req.params.chemistId;
        // Validation
