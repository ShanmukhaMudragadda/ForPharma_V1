...
export const createDoctorHospitalAssociation = async (req, res) => {
    try {
...
export const updateDoctorHospitalAssociation = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
...
export const deleteDoctorHospitalAssociation = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const associationId = req.params.associationId;
        // Validation
...
export const setPrimaryHospital = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
