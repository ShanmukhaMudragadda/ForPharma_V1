...
export const createDoctorConsultationSchedule = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const { doctorId, hospitalId, dayOfWeek, startTime, endTime, consultationType, isActive, effectiveFrom, effectiveTo } = req.body;
        // Validation
        if (!tenantDb) {
...
export const getDoctorSchedules = async (req, res) => {
    try {
        ...
        const schedulesByHospital = schedules.reduce((acc, schedule) => {
...
export const updateDoctorConsultationSchedule = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const scheduleId = req.params.scheduleId;
        const { dayOfWeek, startTime, endTime, consultationType, isActive, effectiveFrom, effectiveTo } = req.body;
        // Validation
        if (!tenantDb) {
            return res.status(500).json({
                success: false,
...
export const deleteDoctorConsultationSchedule = async (req, res) => {
    try {
        const tenantDb = req.tenantDb;
        const scheduleId = req.params.scheduleId;
        // Validation
