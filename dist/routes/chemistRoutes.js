...
import { createChemistController, updateChemist, deleteChemist, getChemistListController, getChemistDetails } from '../controllers/chemists/chemistController';
import { 
// ChemistNote Controllers
createChemistNote, getNotesForChemist, getChemistNotesByEmployee, updateChemistNote, deleteChemistNote } from '../controllers/chemists/chemistNoteController';
import { 
// ChemistInteraction Controllers
createChemistInteraction, getInteractionsForChemist, getChemistInteractionsByEmployee, updateChemistInteraction, deleteChemistInteraction, } from '../controllers/chemists/chemistInteractionController';
import { 
// DoctorChemistRelation Controllers
createDoctorChemistRelation, getChemistsForDoctor, getDoctorsForChemist, deleteDoctorChemistRelation } from '../controllers/chemists/doctorChemistRelationController';
