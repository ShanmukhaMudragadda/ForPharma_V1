...
import { createDoctorController, getDoctorListController, updateDoctor, deleteDoctor, getDoctorDetails, } from '../controllers/doctors/doctorController';
import { 
// DoctorHospitalAssociation
createDoctorHospitalAssociation, getDoctorHospitals, updateDoctorHospitalAssociation, deleteDoctorHospitalAssociation, setPrimaryHospital, } from '../controllers/doctors/doctorHospitalAssociation';
import { 
// DoctorConsultationSchedule
createDoctorConsultationSchedule, getDoctorSchedules, updateDoctorConsultationSchedule, deleteDoctorConsultationSchedule, toggleScheduleStatus, } from '../controllers/doctors/doctorConsultationController';
import { 
// DoctorNote
createDoctorNote, getNotesForDoctor, getNotesByEmployee, updateDoctorNote, deleteDoctorNote, } from '../controllers/doctors/doctorNoteController';
import { 
// DoctorInteraction
createDoctorInteraction, getInteractionsForDoctor, getInteractionsByEmployee, updateDoctorInteraction, deleteDoctorInteraction } from '../controllers/doctors/doctorIntreactionController';
