...
//         try {
//             const response = await drugService.searchDrugs(query);
...
//         const currentPromoted = productsPromoted ? `${productsPromoted}, ` : '';
//         setProductsPromoted(`${currentPromoted}${drug.name}`);
//     };
