...
//     { icon: 'people-outline', label: 'Doctors', route: '/doctors' },
//     { icon: 'medical-outline', label: 'Chemists', route: '/chemists' },
//     { icon: 'clipboard-outline', label: 'Orders', route: '/orders' },
//     { icon: 'stats-chart-outline', label: 'Reports', route: '/reports' },
//     { icon: 'calendar-outline', label: 'Tour Plan', route: '/tour-plan' },
//     { icon: 'wallet-outline', label: 'Expenses', route: '/expenses' },
//     { icon: 'book-outline', label: 'Products', route: '/products' },
//   ];
...
//         >
//           {/* Drawer Header */}
//           {/* className="bg-[#0077B6] px-6 pt-12 pb-6" */}
...
//           }}>
//             {/* className="text-xl pt-14 font-bold text-white" */}
//             <StyledText style={{
//                 fontSize:27,
//                 color:"white",
//                 marginLeft:10
...
//                 <Ionicons style={{
//                     marginLeft:10
//                 }} name={item.icon as any} size={24} color="#212529" />
