...
export function EndMeetingModal({ visible, doctorName, onCancel, onConfirm }: EndMeetingModalProps) {
    return (
        <StyledModal
            animationType="fade"
            transparent={true}
            ...
            <StyledView className="flex-1 bg-black/50 justify-center items-center px-5">
                <StyledView className="bg-white rounded-2xl p-6 w-full max-w-sm">
                    ...
                    <StyledText className="text-sm text-gray-600 text-center mb-6">
                        Are you sure you want to end this meeting with {doctorName}? This will save your DCR and log the meeting details.
                    </StyledText>
