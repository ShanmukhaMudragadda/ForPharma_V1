...
import {
  ...
  ArrowLeft, Save, X, Building2, AlertTriangle, Globe
} from 'lucide-react';
...
const HospitalsView = () => {
  ...
  const hospitals: Hospital[] = [
    {
      ...
      territory: 'North District', bedCount: 250, status: 'active', createdAt: '2024-01-05'
    },
    {
      ...
      territory: 'West District', bedCount: 150, status: 'active', createdAt: '2024-01-12'
    },
    {
      ...
      territory: 'South District', bedCount: 120, status: 'inactive', createdAt: '2024-01-08'
    },
  ];

  const [hospitalsList] = useState<Hospital[]>(hospitals);
  ...
  const handleCreateHospital = async () => {
    ...
    try {
      ...
      // const response = await adminService.createHospital(hospitalForm);
      resetForm();
            ...
            <table className="w-full">
              <thead className="bg-background-tertiary">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-semibold text-text-secondary uppercase tracking-wider font-heading">Beds</th>
                ...
                <div className="space-y-4">
                  <FormCard title="Hospital Information">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div><strong>Beds:</strong> {selectedHospital.bedCount || 'Not specified'}</div>
                    </div>
                  </FormCard>
